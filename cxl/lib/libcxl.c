...
static int cxl_delete_pmem_region_label(struct cxl_region *region)
{
	const char *devname = cxl_region_get_devname(region);
	struct cxl_ctx *ctx = cxl_region_get_ctx(region);
	int len = region->buf_len, rc;
...
CXL_EXPORT int cxl_pmem_region_label_delete(struct cxl_region *region)
{
	const char *devname = cxl_region_get_devname(region);
	struct cxl_ctx *ctx = cxl_region_get_ctx(region);
	int rc;
	...
	rc = cxl_delete_pmem_region_label(region);
	if (rc) {
